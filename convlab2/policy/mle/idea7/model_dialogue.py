...
class dialogue_VAE(nn.Module):
    def __init__(self, embedding_size, rnn_type, hidden_size, word_dropout, embedding_dropout, latent_size,
        ...
        self.discriminator_layer4 = nn.Linear(hidden_size* self.hidden_factor, 512)
        self.discriminator_layer5 = nn.Linear(512, 128)
        self.discriminator_layer6 = nn.Linear(128, 32)
        self.discriminator_layer7 = nn.Linear(32, 9)
    ...
    def forward(self, input_sequence, mask_id):
        ...
        input_hidden = input_hidden.to("cuda")
