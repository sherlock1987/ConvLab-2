...
class PPO(Policy):
    def __init__(self, is_train=False, dataset='Multiwoz'):
        ...
        self.reward_predictor1 = Model1(549, "gru", 512, 1, 1, 256, 60, 1, True)
        self.reward_predictor2 = Model2(549, 457, 209)
    ...
    def reward_estimate(self, r, s, a, mask):
        ...
        """
        ae_reward = self.reward_predictor1.get_reward(r, s, a, mask)
        domain_reward = self.reward_predictor2.get_reward(r, s, a, mask)
        reward_predict = ae_reward + domain_reward + r
