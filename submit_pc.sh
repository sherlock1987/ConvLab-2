...
'> ${config_path}
  CUDA_VISIBLE_DEVICES=0 python ${RL_path} --load_path ${load_path} --load_path_reward_d ${root}/convlab2/policy/mle/idea4/GAN1/Dis/pretrain_D.mdl --load_path_reward_g ${root}/convlab2/policy/mle/idea4/GAN1/Gen/pretrain_G.mdl
  echo "${log_path}"
  echo " "
